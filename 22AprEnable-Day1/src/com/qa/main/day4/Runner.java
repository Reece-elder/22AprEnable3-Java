...
import com.qa.main.day4.oopRecap.SumClass;
...
//	}
	...
	public static void main(String[] args) {
		// We are accessing the CLASS when we should access the OBJECT
		// new variable called sum = SumClass Object
		SumClass sumProd = new SumClass(); 
		SumClass sumTest = new SumClass();
//		System.out.println(SumClass.addNums(5, 4));
		System.out.println(sumProd.addNums(5, 4));
	}
